...
| Field | Value |
|---|---|
| Status | `[x]` — re-opened by the T6 Pivot (2026-09-19) for one owed clause (**T2 owed clause** below); owed clause PASS 2026-09-19 |
| Size | L |
